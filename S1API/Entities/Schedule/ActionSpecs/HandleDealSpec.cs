...
namespace S1API.Entities.Schedule
{
    ...
    /// This spec is kept for backwards compatibility but is a no-op. NPCs with
    /// <see cref="NPC.IsDealer"/> enabled automatically handle deals when contracts are assigned.
    /// </remarks>
    ...
    public sealed class HandleDealSpec : IScheduleActionSpec
    {
        ...
        void IScheduleActionSpec.ApplyTo(NPCSchedule schedule)
        {
            ...
            // Declared dealers automatically handle deals when contracts are assigned.
